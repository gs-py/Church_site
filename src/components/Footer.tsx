    ...
    <footer id="contact" className="bg-gray-950 text-white">
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex items-start gap-3 text-gray-400">
              ...
              <span>
                ...
                <a href="tel:+919980348867" className="hover:text-white transition-colors duration-200">
                  +91 99803 48867
                </a>
              </span>
            </li>
      ...
      <div className="border-t border-gray-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <Link
            to="/admin"
            className="text-gray-700 hover:text-gray-500 text-xs flex items-center gap-1 transition-colors duration-200"
            title="Admin"
          >
